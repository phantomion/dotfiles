...
vim.api.nvim_set_keymap('n', '<F8>', ':e %<CR>', {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('n', 'E', 'e', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', 'b', 'B', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', 'B', 'b', {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('n', '<A-h>', '5h', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<A-j>', '5j', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<A-k>', '5k', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<A-l>', '5l', {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<A-h>', '5h', {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<A-j>', '5j', {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<A-k>', '5k', {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<A-l>', '5l', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<A-,>', ':1winc > <CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<A-.>', ':1winc < <CR>', {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('n', '<leader>q', '%', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<leader>vw', 'v%', {noremap = true, silent = true})
vim.cmd([[autocmd BufWritePre * %s/\s\+$//e]])
vim.api.nvim_set_keymap('t', '<ESC>', '<C-\\><C-n>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('i', '<C-l>', '<Right>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<leader>tt', ':<c-u>exe v:count1 . "ToggleTerm"<CR>', {noremap = true, silent = true})

vim.api.nvim_set_keymap('v', '<C-c>', '"+y', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<A-v>', '"+p', {noremap = true, silent = true})
vim.cmd([[
